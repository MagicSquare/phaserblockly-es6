...
class PhaserDemo1State extends Phaser.State {
    ...
    create() {
        ...
        let ground = this.m_Platforms.create(0, this.game.world.height - 64, 'ground');
        ...
        let ledge = this.m_Platforms.create(400, 400, 'ground');
        ...
        for (let i = 0; i < 12; i++) {
            ...
            let star = this.m_Stars.create(i * 70, 0, 'star');
